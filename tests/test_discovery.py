...
@pytest.mark.asyncio
async def test_search_stations_success(mock_aioresponses: aioresponses, session: ClientSession) -> None:
...
@pytest.mark.asyncio
async def test_search_stations_empty_query(mock_aioresponses: aioresponses, session: ClientSession) -> None:
...
@pytest.mark.asyncio
async def test_search_stations_http_error(mock_aioresponses: aioresponses, session: ClientSession) -> None:
...
@pytest.mark.asyncio
async def test_search_stations_invalid_json(mock_aioresponses: aioresponses, session: ClientSession) -> None:
...
@pytest.mark.asyncio
async def test_search_stations_invalid_data(mock_aioresponses: aioresponses, session: ClientSession) -> None:
